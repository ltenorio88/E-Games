...
export default async function Home() {
  ...
  const bannerPromotions = [
    {
      id: 1,
      title: "O PROGRAMA DE FIDELIDADE PARA VERDADEIROS GAMERS!",
      description:
        "Acumule pontos, desbloqueie vantagens exclusivas e leve sua experiência gamer para o próximo nível.",
      image: "/images/fidelidade-banner.jpg",
    ...
    },
    {
      ...
      description: "Colecionáveis de edição limitada acabaram de chegar",
      image:
    ...
    {
      id: 3,
      title: "Nova Linha de Vestuário",
      description: "Mostre sua paixão por games com nosso novo vestuário",
      image:
  ...
  return (
    <div className="min-h-screen bg-gray-100 text-white">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <Link href="/category/games" className="group">
              <div className="bg-gray-800 rounded-xl p-8 text-center transition-all hover:bg-purple-700 hover:shadow-xl">
                ...
                <h3 className="text-2xl font-semibold">Jogos</h3>
                <p className="mt-2 text-gray-300">Lançamentos e clássicos</p>
              </div>
            </Link>
            <Link href="/category/collectibles" className="group">
              <div className="bg-gray-800 rounded-xl p-8 text-center transition-all hover:bg-purple-700 hover:shadow-xl">
                ...
                <h3 className="text-2xl font-semibold">Colecionáveis</h3>
                <p className="mt-2 text-gray-300">Figuras, cartas e mais</p>
              </div>
            </Link>
            <Link href="/category/apparel" className="group">
              <div className="bg-gray-800 rounded-xl p-8 text-center transition-all hover:bg-purple-700 hover:shadow-xl">
                <Shirt className="w-16 h-16 mx-auto mb-4 text-purple-400 group-hover:text-white" />
                <h3 className="text-2xl font-semibold">Vestuário</h3>
                <p className="mt-2 text-gray-300">Roupas inspiradas em games</p>
              </div>
            </Link>
          </div>
        </div>
      ...
      <section className="py-16 bg-gray-900">
        <div className="container mx-auto px-4">
          <div className="flex justify-between items-center mb-8">
            <h2 className="text-2xl font-bold">Colecionáveis em Destaque</h2>
            <Link
      ...
      <section className="py-16 bg-gray-800">
        <div className="container mx-auto px-4">
          <div className="flex justify-between items-center mb-8">
            <h2 className="text-2xl font-bold">Vestuário em Destaque</h2>
            <Link
      ...
      <section className="py-20 bg-purple-700">
        <div className="container mx-auto px-4 text-center">
          ...
          <p className="text-xl mb-8 max-w-2xl mx-auto">
            Cadastre-se para ofertas exclusivas, acesso antecipado a novos
          ...
          <div className="flex flex-col sm:flex-row justify-center gap-4">
            <Button
              asChild
              size="lg"
              className="bg-white text-purple-700 hover:bg-gray-900"
            >
